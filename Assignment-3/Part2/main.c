...
void* Func_SPIPatternDisplay(void *ptr)
{
	...
	while(1)
	{
        ...
        else if((currDistance>5)&&(currDistance<10))
        {/* Populate the sequence buffer to execute correspopnding sequence */
           	sequenceBuffer[0] = 1;
			sequenceBuffer[1] = 15;
			sequenceBuffer[2] = 0;
        ...
        else if((currDistance>10)&&(currDistance<15))
        {/* Populate the sequence buffer to execute correspopnding sequence */
            sequenceBuffer[0] = 2;
			sequenceBuffer[1] = 50;
			sequenceBuffer[2] = 0;
        ...
        else if((currDistance>15)&&(currDistance<20))
        {/* Populate the sequence buffer to execute correspopnding sequence */
            sequenceBuffer[0] = 3;
			sequenceBuffer[1] = 50;
			sequenceBuffer[2] = 0;
        ...
        else if((currDistance>20)&&(currDistance<25))
        {/* Populate the sequence buffer to execute correspopnding sequence */
           	sequenceBuffer[0] = 4;
			sequenceBuffer[1] = 50;
			sequenceBuffer[2] = 0;
        ...
        else if((currDistance>25)&&(currDistance<30))
        {/* Populate the sequence buffer to execute correspopnding sequence */
           	sequenceBuffer[0] = 5;
			sequenceBuffer[1] = 50;
			sequenceBuffer[2] = 0;
		...
		else if((currDistance>30)&&(currDistance<35))
        {/* Populate the sequence buffer to execute correspopnding sequence */
           	sequenceBuffer[0] = 6;
			sequenceBuffer[1] = 50;
			sequenceBuffer[2] = 0;
		...
		else if((currDistance>35)&&(currDistance<40))
        {/* Populate the sequence buffer to execute correspopnding sequence */
           	sequenceBuffer[0] = 7;
			sequenceBuffer[1] = 50;
			sequenceBuffer[2] = 0;
 		...
 		else if((currDistance>40)&&(currDistance<45))
        {/* Populate the sequence buffer to execute correspopnding sequence */
           	sequenceBuffer[0] = 8;
			sequenceBuffer[1] = 50;
			sequenceBuffer[2] = 0;
...
void* Func_SPITestTransmit(void *ptr)
{
	...
	write(fd, sequenceBuffer, sizeof(sequenceBuffer));
	usleep(50000);
	}
